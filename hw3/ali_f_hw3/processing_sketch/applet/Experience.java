...
public class Experience implements Comparable {
	...
	public static Experience[] ALL = new Experience[] { OVER_THREE_YEARS, ONE_TO_THREE_YEARS, BETWEEN_SIX_MONTHS_AND_ONE_YEAR, LESS_THAN_SIX_MONTHS };
	...
	public int compareTo(Object y) {
		...
		return new Integer(experienceY.getOrder()).compareTo(new Integer(this.getOrder()));
	}
